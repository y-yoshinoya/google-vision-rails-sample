...
SimpleForm.setup do |config|
  ...
  config.boolean_label_class = 'form-check-label custom-control-label'
  ...
  config.wrappers :vertical_boolean, tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :form_check_wrapper, tag: 'div', class: 'form-check custom-checkbox' do |bb|
      bb.use :input, class: 'form-check-input custom-control-input', error_class: 'is-invalid', valid_class: 'is-valid'
      bb.use :label, class: 'form-check-label custom-control-label'
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check custom-checkbox', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
    end
    b.use :input, class: 'form-check-input custom-control-input', error_class: 'is-invalid', valid_class: 'is-valid'
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |wr|
      wr.wrapper :form_check_wrapper, tag: 'div', class: 'form-check custom-checkbox' do |bb|
        bb.use :input, class: 'form-check-input custom-control-input', error_class: 'is-invalid', valid_class: 'is-valid'
        bb.use :label, class: 'form-check-label custom-control-label'
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check custom-checkbox', tag: 'div', class: 'form-group row', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 form-control-label'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-check-input custom-control-input', error_class: 'is-invalid', valid_class: 'is-valid'
  ...
  config.wrappers :inline_boolean, tag: 'span', class: 'form-check custom-checkbox flex-wrap justify-content-start mr-sm-2', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'form-check-input custom-control-input', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :label, class: 'form-check-label custom-control-label'
    b.use :error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.optional :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
